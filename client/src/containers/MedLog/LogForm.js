...
import { Typography,InputLabel,FormControl,MenuItem,Button,TextField,Card,CardContent,withStyles,Tooltip,IconButton} from '@material-ui/core';
        ...
        <Card className={classes.root}>
          <CardContent>
            ...
            <form noValidate autoComplete="off" id="log-form">
              ...
              <FormControl className={classes.formControl} fullWidth>
                <InputLabel htmlFor="bp">
                  <span>
                    Blood pressure (mm of Hg):
                    <Tooltip  
                      title="Enter the blood pressure measurements "
                      placement="top">
                      <IconButton> <i className="material-icons">help</i></IconButton>
                    </Tooltip>
                  </span></InputLabel>
                <TextField
                  ...
                  margin="normal"
                  className={classes.textField}
                  value={this.props.logbp}
                  onChange={this.props.handleLogbpChange}
                />
                <Typography className={classes.formError} component="p">{this.props.logbpError}</Typography>
              </FormControl>
